  ...
  return (
    ...
    >
      ...
      >
        ...
        Ukraine, Russia and Sweden. In 2020 his developing skills and
        ...
        and appreciated across the world with recent releases on multiple known
        psytrance labels, like IONO records, SOL Music and GreenTree Records.
      </Typography>
    </Grid>
  );
}
